...
public class GamePacketHandler extends PacketHandler {
	...
	private GamePacketHandler() {
		...
		addPacketPrototype(new CM_ENTER(0xA13));
		...
		addPacketPrototype(new CM_EQUIPMENT_ENTER(0xE01));
		addPacketPrototype(new CM_EQUIPMENT_LEAVE(0xE05));
		...
		addPacketPrototype(new CM_ROOM_CHANGE_HOST(0xF1E)); //new -- TODO: функционал и серверный пакет
		...
		addPacketPrototype(new CM_BATTLE_BOMB_TAB(0xF1E)); //TODO: опкод
		addPacketPrototype(new CM_BATTLE_BOMB_UNTAB(0xF20)); //TODO: опкод
		addPacketPrototype(new CM_ROUND_END(0xF1C)); //0xF1C
		addPacketPrototype(new CM_ROUND_START(0xD33)); //0xD33
		...
		addPacketPrototype(new CM_BATTLE_FINAL(0xF42)); //TODO: найти опкод
		...
		addPacketPrototype(new CM_ROOM_CHANGE_SETTINGS_PART1(0xF07)); //Пакет смены настроек комнаты
		//кланы - пакеты создания клана
		addPacketPrototype(new CM_CREATE_CLAN_REQ(0x588));
		addPacketPrototype(new CM_CLAN_CREATE_NICK_NAME(0x5A7));
		addPacketPrototype(new CM_CLAN_CREATE(0x51E)); //создание клана происходит после 2х верхних пакетов
		//title get/aquisition
