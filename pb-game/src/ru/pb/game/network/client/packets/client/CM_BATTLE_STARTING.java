 ...
 * @author sjke
 */
public class CM_BATTLE_STARTING extends ClientPacket {

	public CM_BATTLE_STARTING(int opcode) {
		super(opcode);
	}

	@Override
	public void readImpl() {
		readS(readC()); // map name
	}

	@Override
	public void runImpl() {
		final Room room = getConnection().getRoom();
		getConnection().getRoom().getRoomSlotByPlayer(getConnection().getPlayer()).setState(SlotState.SLOT_STATE_RENDEZVOUS);
