...
import ru.pb.game.network.client.packets.server.SM_CLAN_LEAVE;
...
/**
 * Пакет выхода из клана
 *
 * @author: Felixx, DarkSkeleton
 */
public class CM_CLAN_LEAVE extends ClientPacket {
	public CM_CLAN_LEAVE(int opcode) {
		super(opcode);
	}
