...
import ru.pb.game.network.client.packets.server.SM_EQUIPMENT_ENTER;
 ...
 */
public class CM_EQUIPMENT_ENTER extends ClientPacket {

	public CM_EQUIPMENT_ENTER(int opcode) {
		super(opcode);
	}
	...
	public void runImpl() {
		...
		sendPacket(new SM_EQUIPMENT_ENTER());
	}
